...
import "../../src/week-9-10/the-rewarder/FlashLoanerPool.sol";
import "../../src/week-9-10/the-rewarder/TheRewarderPool.sol";
import "../../src/week-9-10/the-rewarder/Attacker.sol";
...
contract TheRewarderTest is Test {
    ...
    function testIncrement() public {
        ...
        // Advance time by 5 days so a new round can begin
        skip(5 days);

        attacker = new Attacker(rewarderPool, flashLoanPool, liquidityToken);
        attacker.exploit();
