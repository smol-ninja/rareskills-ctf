...
contract ExploitContract {
    ...
    /**
     * the exploit is a result of a block property of ethereum blockchain that restricts
     * accessing blockhash of the 256 most recent blocks otherwise produces 0x 
     * 
     * msg.sender == guesser guarantees no frontrunning
     */
    // see test file for exploit code
}