...
// add your exploiter contract here (check test file, this does not require any contract deployment)
/**
 * Step 1: The attacker nominates himself as a challenger using `nominateChallenger()`. This will mint
 * 2 NFTs to attacker and grant him 3 votes.
 * 
 * Step 2: Since `vote()` only checks for NFT balance, attacker can get more votes than his NFT balance
 * by voting first and then transferring those NFTs to another address and vote again
 * 
 * Step 3: Finally after winning the electron, attacker can withdraw ether and rug democracy.
 */